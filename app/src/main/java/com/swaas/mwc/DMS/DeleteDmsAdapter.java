...
public class DeleteDmsAdapter extends RecyclerView.Adapter<DeleteDmsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        DeleteDmsAdapter.ViewHolder vh;
    ...
    @Override
    public DeleteDmsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.file_items, parent, false);
        DeleteDmsAdapter.ViewHolder vh = new DeleteDmsAdapter.ViewHolder(v);
        return vh;
    }
    ...
    public void setClickListener(DeleteDmsAdapter.ItemClickListener itemClickListener) {
    ...
    @Override
    public void onBindViewHolder(final DeleteDmsAdapter.ViewHolder holder, final int position) {
