...
public interface DeleteEndUserFolderService {

    @Headers("content-type: application/x-www-form-urlencoded")
    @POST("/delete-eu-folders")
    @FormUrlEncoded
    Call<ApiResponse<LoginResponse>> delete_eu_folder(@FieldMap Map<String, String> params, @Header("access-token") String accessToken);
}
