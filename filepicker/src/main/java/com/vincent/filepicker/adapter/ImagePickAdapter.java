...
public class ImagePickAdapter extends BaseAdapter<ImageFile, ImagePickAdapter.ImagePickViewHolder> {
  ...
  //  private int mMaxNumber;
    ...
    public ImagePickAdapter(Context ctx, boolean needCamera, boolean isNeedImagePager) {
        this(ctx, new ArrayList<ImageFile>(), needCamera, isNeedImagePager);
    }

    public ImagePickAdapter(Context ctx, ArrayList<ImageFile> list, boolean needCamera, boolean needImagePager) {
        super(ctx, list);
